...
const NavBar = () => {
    ...
    return (
        ...
        >
            {/* Desktop */}
            <ul className="md:flex hidden max-w-[1120px] w-[78%]  items-center text-[16px] leading-[21px] font-medium text-black bg-white mx-[auto] h-[60px]">
                ...
                <li>
                    {currentPage === "driver" ? (
                        <Link href="/">
                            <button
                                className="hover:rounded-none transition-all duration-300 bg-white  py-[12px] px-[20px] font-[500] rounded-[30px] border-[#E6E5E3] border-solid border-[1px] text-[16px] mr-[16px]">
                        ...
                        <Link href="/driver">
                            <button
                                className="hover:rounded-none transition-all duration-300 bg-white  py-[12px] px-[16px] font-[500] rounded-[30px] border-[#E6E5E3] border-solid border-[1px] text-[16px] mr-[20px]">
                ...
                <li>
                    <Link href="/">
                        <button
                            className="hover:rounded-none transition-all duration-300 bg-tertiary bg-opacity-30 py-[12px] px-[24px] font-[700] rounded-[30px]">
                            Register
                        </button>
                    </Link>
                </li>
...
"
          ...
          <span className="hover:scale-[1.1] ">
            <Link href="/">
              ...
              <Link href="#scan">
                <button
                    className="hover:rounded-none transition-all duration-300 bg-primary  py-[8px] px-[33px] font-[500] rounded-[30px] border-[#E6E5E3] border-solid border-[1px] text-[14px]">
                  Download the App
                </button>
              </Link>
            </span>
