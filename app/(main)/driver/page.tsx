...
const Home: React.FC = () => {
  ...
  return (
    <div className="relative" id="top">
      ...
      <section className="mt-[62px] max-w-[1300px] mx-auto md:w-[78%]">
      ...
      {/* Price Comparison */}
      <section
        className="md:mt-[131px] mt-[96px] md:mb-[29x] max-w-[1300px] mx-auto md:w-[78%] md:pb-[100px]"
        id="price-comparison"
      >
        <div className="md:px-0 px-[24px]">
          <PriceComparison />
      ...
      {/* Is It Safe */}
      <section className="md:mt-[288px] mt-[120px]  max-w-[1300px] md:w-[78%] mx-auto ">
        <div className="md:px-0 px-[24px]">
          <IsSafe />
        </div>
      </section>
